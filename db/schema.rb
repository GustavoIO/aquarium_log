...
ActiveRecord::Schema[7.1].define(version: 2026_01_03_000002) do
  ...
  create_table "measurements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aquarium_id", "measured_at"], name: "index_measurements_on_aquarium_id_and_measured_at"
    t.index ["aquarium_id"], name: "index_measurements_on_aquarium_id"
  end

  add_foreign_key "measurements", "aquariums"
end
